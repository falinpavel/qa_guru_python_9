...
class PracticeFormPage:
    ...
    #     browser.all('.custom-radio').should(have.size(3)).should(
    #         have.exact_texts(gender_text_male, gender_text_female, gender_text_other))
    ...
    #     browser.all('.custom-checkbox').should(have.size(3)).should(
    #         have.exact_texts(hobbies_text_sport, hobbies_text_reed, hobbies_text_music))
